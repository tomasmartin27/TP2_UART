...
initial $monitor("din1 = %b, tx1 = %b, tx_done1 = %b", din1, tx1, tx_done1, $time);
initial $monitor("din2 = %b, tx2 = %b, tx_done2 = %b", din2, tx2, tx_done2, $time);
initial $monitor("dout1 = %b, rx1 = %b, rx_done1 = %b", dout1, rx1, rx_done1, $time);
initial $monitor("dout2 = %b, rx2 = %b, rx_done2 = %b", dout2, rx2, rx_done2, $time);
